...
<header class="sticky top-0 z-50 flex items-center justify-between border-b border-slate-200/80 bg-background-light/80 px-4 py-3 backdrop-blur-sm dark:border-slate-800/80 dark:bg-background-dark/80 sm:px-6 lg:px-8">
  ...
  <div class="flex items-center gap-4">
    ...
    <Transition
      ...
      <div
        v-if="showMobileNav"
        class="fixed left-0 right-0 top-[64px] z-40 block md:hidden border-t border-slate-200 dark:border-slate-800 bg-background-light dark:bg-background-dark shadow-lg"
      >
        <nav class="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8 block md:hidden">
